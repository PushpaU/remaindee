...
class MyApp extends StatefulWidget {
  ...
  @override
  State<MyApp> createState() => _MyAppState();//check
}
...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: Column(
          children: user.remainders.where((remainderObj) => remainderObj.time.isAfter(DateTime.now()))
              .map((remainderObj) => Cards(
                    remainder: remainderObj,
                    deleteFunction: () {
                      setState(() {
                        user.remainders.remove(remainderObj);
                      });
                    },
                  ))
              .toList(),
